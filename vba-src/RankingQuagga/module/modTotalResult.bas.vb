...
'Private Function GetShapeByZOrderSlide(sld As slide, index As Integer, keyword As String) As Shape
'    Dim colShapes As New Collection
'    Call CollectMatchingShapes(sld.shapes.Range, keyword, colShapes)
'
'    If colShapes.Count = 0 Then
'        MsgBox keyword & "のオブジェクトがありません", vbCritical
'        Exit Function
'    End If
'
...
'        MsgBox keyword & "のオブジェクトが足りません", vbCritical
'        Exit Function
'    End If
'
'    Set GetShapeByZOrderSlide = sortedShapes(index - 1)
'End Function
